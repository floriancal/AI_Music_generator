        ...
        private void ParseWordEvent(Enums.Event eventId, BinaryReader reader)
        {
            ...
            switch (eventId)
            {
                ...
                case Enums.Event.WordNewPat:
                    while (_project.Patterns.Count < data) _project.Patterns.Add(new Pattern { Id = _project.Patterns.Count }); //// MODIF HERREEEEE <= au lieu de < 
        ...
        private void ParseTextEvent(Enums.Event eventId, BinaryReader reader)
        {
            ...
            switch (eventId)
            {
                ...
                case Enums.Event.TextVersion:
                    ...
                    Console.WriteLine("maj" + _versionMajor);
                ...
                case Enums.Event.DataChanParams:
                    {
                        ...
                        /* List<byte[]> bytelist = new List<byte[]>();
                         bytelist.Add(unknown3);
                         foreach (byte[] elemn in bytelist)
                         {
                             foreach (byte abyte in elemn)
                             {
                                 Console.WriteLine("u1" + abyte);
                             }
